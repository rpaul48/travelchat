...
/**
 * Tests BrowseActivitiesHandler Class (user input type validity).
 */
public class BrowseActivitiesHandlerTest {
  @Test
  ...
  public String paramsAreValid(Map<String, Object> params) {
    ...
    /*
     * Other variables for Attraction querying do not need to be checked as they're
     * options from dropdown menus that we know are all valid.
     */
