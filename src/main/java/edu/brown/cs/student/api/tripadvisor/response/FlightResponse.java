...
/**
 * A response for flights from the TripAdvisor API; specifically, the information we need for our app.
...
public class FlightResponse {
     ...
     */
    public List<Flight> getData(HttpResponse<JsonNode> response) throws UnirestException {
