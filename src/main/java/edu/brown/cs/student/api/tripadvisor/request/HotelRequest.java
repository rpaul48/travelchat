...
public class HotelRequest {
  ...
  public String run() throws UnirestException {
    ...
    HttpResponse<String> response = Unirest.get(hostURL).header("x-rapidapi-host", x_rapidapi_host)
        .header("x-rapidapi-key", x_rapidapi_key).queryString(immutableParams).asString();
