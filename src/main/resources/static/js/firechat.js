...
this["FirechatDefaultTemplates"]["templates/message.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class=\'message message-' +__e( type ) +' '; if (isSelfMessage) { ;__p += ' message-self '; } ;__p += '\'data-message-id=\'' +__e( id ) +'\' data-user-id=\'' +__e( userId ) +'\' data-user-name=\'' +__e( name ) +'\' data-class="firechat-message"><div class=\'clearfix\'><label class=\'fourfifth\'><strong class=\'name\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</strong><em>(' +__e( localtime ) +')</em>:</label>'; if (!disableActions) { ;__p += '<label class=\'fifth alignright\'><a href=\'#!\' data-event=\'firechat-user-chat\' class=\'icon user-chat\' title=\'Invite to Private Chat\'>&nbsp;</a><a href=\'#!\' data-event=\'firechat-user-mute-toggle\' class=\'icon user-mute\' title=\'Mute User\'>&nbsp;</a></label>'; } ;__p += '</div><div class=\'clearfix message-content\'>' +((__t = ( message )) == null ? '' : __t) +'</div></div>';}return __p};
...
this["FirechatDefaultTemplates"]["templates/tab-content.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div id=\'' +__e( id ) +'\' data-room-id=\'' +__e( id ) +'\' class=\'tab-pane\'><div class=\'tab-pane-menu clearfix\'><div id="add-user" class=\'firechat-dropdown twofifth\'><a id="add-user-a" data-event=\'firechat-user-search-btn\' class=\'full btn\' data-toggle="firechat-dropdown" href=\'#\'>Add User ＋</a><div class=\'firechat-dropdown-menu\' role=\'menu\'><div class=\'firechat-dropdown-header aligncenter clearfix\'><div class=\'search-wrapper\'><span class=\'icon search\'></span><input aria-label="Invitee email" type=\'text\' id=\'invite-search\' placeholder=\'Invitee email\' class=\'center fivesixth\'></div></div><ul id=\'firechat-room-user-search-' +__e( id ) +'\'></ul><div class=\'firechat-dropdown-footer aligncenter clearfix\'><div id=\'firechat-room-user-search-controls-' +__e( id ) +'\' class=\'clearfix\'><span class="quarter"></span><!--<button type=\'button\' class=\'btn third disabled\' data-event=\'firechat-user-search\' data-template=\'templates/room-user-search-list-item.html\' data-target=\'firechat-room-user-search-' +__e( id ) +'\' data-controls=\'firechat-room-user-search-controls-' +__e( id ) +'\' data-toggle=\'firechat-pagination-prev\' disabled=disabled>Prev</button>--><button type=\'button\' id="add-button" class=\'btn half\' onclick="inviteUser()">Add</button></div></div></div></div><div id=\'budget-menu\' class=\'firechat-dropdown twofifth\'><a id=\'budget-menu-a\' data-event=\'firechat-user-search-btn\' class=\'full btn\' onclick=\'openPopup("budget-div"); displayBudget()\' href=\'#\'>Your Budget</a></div></div><div class=\'clearfix\'><div id=\'firechat-messages' +__e( id ) +'\' class=\'chat\'></div></div><div class=\'clearfix\'><textarea aria-label="Type your message here" id=\'textarea' +__e( id ) +'\' placeholder=\'Type your message here...\'></textarea></div></div>';}return __p};

this["FirechatDefaultTemplates"]["templates/tab-menu-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<li data-room-id=\'' +__e( id ) +'\'>\n<a href=\'#' +__e( id ) +'\' data-toggle=\'firechat-tab\' id=\'groupName\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</a>\n</li>';}return __p};
