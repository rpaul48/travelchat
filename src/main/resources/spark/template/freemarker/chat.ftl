        ...
        <div class="sidewrapper">
            <div class="sidenav">
                ...
                <ul>
                    ...
                    <li><a href="#"><i class="fas fa-plane"></i>Browse Flights</a></li>
                    <li><a href="#"><i class="fas fa-hotel"></i>Browse Housing</a></li>
                    <li><a href="#"><i class="fas fa-hiking"></i>Browse Activities</a></li>
                </ul>
            </div>
        </div>
        <div class="main">
